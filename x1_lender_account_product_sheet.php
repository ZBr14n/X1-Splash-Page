            ...
            */
            switch(strtolower($parts[1])){
                ...
                default:
                    ...
                    $subject = 'X1 Lender Account Product Sheet: '.$firstName.' '.$lastName;
                    ...
                    if( mail($toEmail, $subject, $body, $headers) ){
                        ...
                        echo "<iframe src=\"https://wlticsites.com/X1Splash/wp-content/uploads/2021/05/X1-Lender-Account-Review_02.2021.pdf\" width=\"100%\" style=\"height:100%\"></iframe>";
...
<title>X1 Lender Account Product Sheet &#8211; X1 Analytics</title>
</head>
<body>
...
<section class="mb-5">
    <div class="text-center">
        <h3>Download Product Sheet – X1 Lender Account Review</h3>
        <h5>Please enter information to download X1 Lender Account Product Sheet</h5>
    </div>
